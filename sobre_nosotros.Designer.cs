namespace GoldenBoots
{
    partial class Inicio
    {
        ...
        private void InitializeComponent()
        {
            ...
            label2.Name = "label2";
            label2.Size = new Size(493, 17);
            label2.TabIndex = 6;
            label2.Text = "¡Descubre nuestro programa de lealtad y obtenga ventajas y beneficios exclusivos!";
            // 
            // label3
            // 
            ...
            label3.TabIndex = 7;
            label3.Text = "Hasta 70% de ahorro en ";
            // 
            // label4
            // 
            label4.AutoSize = true;
            label4.Font = new Font("Times New Roman", 24F, FontStyle.Regular, GraphicsUnit.Point, 0);
            label4.ForeColor = Color.Black;
            label4.Location = new Point(12, 265);
            label4.Name = "label4";
            label4.Size = new Size(264, 36);
            label4.TabIndex = 8;
            label4.Text = "tus estilos favoritos ";
            // 
            // label5
            // 
            ...
            label5.Name = "label5";
            label5.Size = new Size(657, 17);
            label5.TabIndex = 7;
            label5.Text = "¡Aprovecha nuestro descuento de fin de temporada! Obtén hasta un 70% menos en estilos seleccionados. Esta";
            // 
            // label6
            // 
            ...
            label6.Name = "label6";
            label6.Size = new Size(692, 17);
            label6.TabIndex = 9;
            label6.Text = "promoción es por tiempo limitado o hasta agotar existencias, así que no esperes. Recuerda que no es válida con otros";
            // 
            // label7
            // 
